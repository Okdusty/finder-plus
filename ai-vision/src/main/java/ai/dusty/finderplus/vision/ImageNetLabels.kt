 ...
 *
 * Cleaned from the ONNX model zoo `synset.txt` to the first common name per class ("tench,
 * Tinca tinca" -> "tench"), so tags read the way a person would search for them. Index-aligned
 * with the model's 1000-class output — do not reorder.
 */
